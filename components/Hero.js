...
function Hero({ title }) {
  return (
    <>
      <div className="heroWrapper" style={title === "About" ? { backgroundImage: `url(${aboutBG.src})`, backgroundPositionY: "bottom 30%" } : { backgroundImage: `url(${homeBG.src})`, backgroundPositionY: "top" }}>
        <h1>{title}</h1>
      </div>
